...
navigate: storage-check
	@if [ "$${ROS_DISTRO:-}" = "humble" ]; then \
			$(MAKE) navigate-inner NAVIGATE_WITH_RVIZ=false NAVIGATE_WITH_MUJOCO=false NAVIGATE_RECORD_BAG="$(NAVIGATE_RECORD_BAG)" NAVIGATE_SKIP_BUILD="$(NAVIGATE_SKIP_BUILD)" NAVIGATE_DASHBOARD="$(NAVIGATE_DASHBOARD)" DASHBOARD_PORT="$(DASHBOARD_PORT)" DASHBOARD_AUTO_OPEN="$(DASHBOARD_AUTO_OPEN)" NAVIGATE_LAUNCH_ARGS="$(NAVIGATE_LAUNCH_ARGS)" LOCOMOTION_CALIBRATION="$(LOCOMOTION_CALIBRATION)" NAV2_LIMIT_MODE="$(NAV2_LIMIT_MODE)"; \
		else \
			DOCKER_IMAGE="$(DOCKER_IMAGE)" ROS_DOMAIN_ID="$(ROS_DOMAIN_ID)" docker/run.sh make navigate-inner NAVIGATE_WITH_RVIZ=false NAVIGATE_WITH_MUJOCO=false NAVIGATE_RECORD_BAG="$(NAVIGATE_RECORD_BAG)" SEED="$(SEED)" CELL_SIZE_M="$(CELL_SIZE_M)" NAVIGATE_DURATION="$(NAVIGATE_DURATION)" CONFIG="$(CONFIG)" RUN_ROOT="$(RUN_ROOT)" NAVIGATE_SKIP_BUILD="$(NAVIGATE_SKIP_BUILD)" NAVIGATE_DASHBOARD="$(NAVIGATE_DASHBOARD)" DASHBOARD_PORT="$(DASHBOARD_PORT)" DASHBOARD_AUTO_OPEN="$(DASHBOARD_AUTO_OPEN)" NAVIGATE_LAUNCH_ARGS="$(NAVIGATE_LAUNCH_ARGS)" LOCOMOTION_CALIBRATION="$(LOCOMOTION_CALIBRATION)" NAV2_LIMIT_MODE="$(NAV2_LIMIT_MODE)"; \
		fi
...
navigate-view: storage-check
	@if [ "$${ROS_DISTRO:-}" = "humble" ]; then \
			$(MAKE) navigate-inner NAVIGATE_WITH_RVIZ=true NAVIGATE_WITH_MUJOCO=false NAVIGATE_RECORD_BAG="$(NAVIGATE_RECORD_BAG)" NAVIGATE_SKIP_BUILD="$(NAVIGATE_SKIP_BUILD)" NAVIGATE_DASHBOARD="$(NAVIGATE_DASHBOARD)" DASHBOARD_PORT="$(DASHBOARD_PORT)" DASHBOARD_AUTO_OPEN="$(DASHBOARD_AUTO_OPEN)" NAVIGATE_LAUNCH_ARGS="$(NAVIGATE_LAUNCH_ARGS)" LOCOMOTION_CALIBRATION="$(LOCOMOTION_CALIBRATION)" NAV2_LIMIT_MODE="$(NAV2_LIMIT_MODE)"; \
		else \
			DOCKER_IMAGE="$(DOCKER_IMAGE)" ROS_DOMAIN_ID="$(ROS_DOMAIN_ID)" docker/run_gui.sh make navigate-inner NAVIGATE_WITH_RVIZ=true NAVIGATE_WITH_MUJOCO=false NAVIGATE_RECORD_BAG="$(NAVIGATE_RECORD_BAG)" SEED="$(SEED)" CELL_SIZE_M="$(CELL_SIZE_M)" NAVIGATE_DURATION="$(NAVIGATE_DURATION)" CONFIG="$(CONFIG)" RUN_ROOT="$(RUN_ROOT)" NAVIGATE_SKIP_BUILD="$(NAVIGATE_SKIP_BUILD)" NAVIGATE_DASHBOARD="$(NAVIGATE_DASHBOARD)" DASHBOARD_PORT="$(DASHBOARD_PORT)" DASHBOARD_AUTO_OPEN="$(DASHBOARD_AUTO_OPEN)" NAVIGATE_LAUNCH_ARGS="$(NAVIGATE_LAUNCH_ARGS)" LOCOMOTION_CALIBRATION="$(LOCOMOTION_CALIBRATION)" NAV2_LIMIT_MODE="$(NAV2_LIMIT_MODE)"; \
		fi

navigate-full-view: storage-check
	@if [ "$${ROS_DISTRO:-}" = "humble" ]; then \
			$(MAKE) navigate-inner NAVIGATE_WITH_RVIZ=true NAVIGATE_WITH_MUJOCO=true NAVIGATE_RECORD_BAG="$(NAVIGATE_RECORD_BAG)" NAVIGATE_SKIP_BUILD="$(NAVIGATE_SKIP_BUILD)" NAVIGATE_DASHBOARD="$(NAVIGATE_DASHBOARD)" DASHBOARD_PORT="$(DASHBOARD_PORT)" DASHBOARD_AUTO_OPEN="$(DASHBOARD_AUTO_OPEN)" NAVIGATE_LAUNCH_ARGS="$(NAVIGATE_LAUNCH_ARGS)" LOCOMOTION_CALIBRATION="$(LOCOMOTION_CALIBRATION)" NAV2_LIMIT_MODE="$(NAV2_LIMIT_MODE)"; \
		else \
			DOCKER_IMAGE="$(DOCKER_IMAGE)" ROS_DOMAIN_ID="$(ROS_DOMAIN_ID)" docker/run_gui.sh make navigate-inner NAVIGATE_WITH_RVIZ=true NAVIGATE_WITH_MUJOCO=true NAVIGATE_RECORD_BAG="$(NAVIGATE_RECORD_BAG)" SEED="$(SEED)" CELL_SIZE_M="$(CELL_SIZE_M)" NAVIGATE_DURATION="$(NAVIGATE_DURATION)" CONFIG="$(CONFIG)" RUN_ROOT="$(RUN_ROOT)" NAVIGATE_SKIP_BUILD="$(NAVIGATE_SKIP_BUILD)" NAVIGATE_DASHBOARD="$(NAVIGATE_DASHBOARD)" DASHBOARD_PORT="$(DASHBOARD_PORT)" DASHBOARD_AUTO_OPEN="$(DASHBOARD_AUTO_OPEN)" NAVIGATE_LAUNCH_ARGS="$(NAVIGATE_LAUNCH_ARGS)" LOCOMOTION_CALIBRATION="$(LOCOMOTION_CALIBRATION)" NAV2_LIMIT_MODE="$(NAV2_LIMIT_MODE)"; \
		fi
...
navigate-inner: storage-check
	...
	bag_path="$(abspath .)/$$run_dir/rosbag"; bag_log="$(abspath .)/$$run_dir/rosbag-record.log"; bag_pid=""; \
	if [ "$(NAVIGATE_RECORD_BAG)" = "false" ] && [ -z "$(NAVIGATE_CAPTURE_SCHEMA)" ]; then \
		echo "ROS bag recording disabled for this run."; \
	elif [ -n "$(NAVIGATE_CAPTURE_SCHEMA)" ]; then \
