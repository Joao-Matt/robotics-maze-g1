...
def generate_launch_description():
    ...
    camera_rate=LaunchConfiguration("camera_rate_hz")
    depth_only=LaunchConfiguration("depth_only")
    goal_reached_tolerance=LaunchConfiguration("goal_reached_tolerance_m")
    goal_reached_tolerance_fraction=LaunchConfiguration("goal_reached_tolerance_cell_width_fraction")
    ...
    bridge=Node(package="g1_mujoco_bridge",executable="bridge_node",name="g1_mujoco_bridge",output="screen",parameters=[PathJoinSubstitution([bridge_share,"config","bridge.yaml"]),{
        ...
        "clock_rate_hz":50.0,"camera_enabled":ParameterValue(camera_enabled,value_type=bool),"camera_rate_hz":ParameterValue(camera_rate,value_type=float),"livox_mid360_enabled":True,"livox_scan_rate_hz":10.0,
        "livox_horizontal_bins":720,"livox_range_min_m":0.10,"livox_range_max_m":40.0,
        "depth_only":ParameterValue(depth_only,value_type=bool),"live_visual_dir":"","navigation_visuals":False}])
